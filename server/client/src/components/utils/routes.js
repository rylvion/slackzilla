...
const routes = [
    ...
    { id: "admin-login", label: "Admin", to: "/admin/login", description: "Login to the admin panel", danger: false, api: false, hidden: false, component: lazy(() => import("../../pages/admin/Login")), children: [] },
    // API 
    ...
    // add more routes here as needed, following the same structure
